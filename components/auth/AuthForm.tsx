          ...
          {mode === 'register' && (
            <div style={{ marginTop: '8px', marginBottom: '4px' }}>
              <label style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', cursor: 'pointer', fontSize: '13px', color: '#374151' }}>
                ...
                <span>
                  我已阅读并同意
                  <a href="/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#1A73E8', textDecoration: 'none', margin: '0 2px' }}>
                    《服务协议》
                  </a>
                  和
                  <a href="/privacy" target="_blank" rel="noopener noreferrer" style={{ color: '#1A73E8', textDecoration: 'none', margin: '0 2px' }}>
                    《隐私政策》
                  </a>
                </span>
              </label>
